...
/* harmony import */ var _modules_changeState__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/changeState */ "./src/js/modules/changeState.js");
...
/* harmony import */ var _modules_loadStyle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/loadStyle */ "./src/js/modules/loadStyle.js");
...
/* harmony import */ var _modules_accordionUpdate__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/accordionUpdate */ "./src/js/modules/accordionUpdate.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var modalState = {};
  Object(_modules_changeState__WEBPACK_IMPORTED_MODULE_2__["default"])(modalState);
  ...
  Object(_modules_loadStyle__WEBPACK_IMPORTED_MODULE_6__["default"])('.button-styles', '#styles .row');
  ...
  Object(_modules_accordionUpdate__WEBPACK_IMPORTED_MODULE_10__["default"])('.accordion-heading');
...
/***/ "./src/js/modules/accordionUpdate.js":
/*!*******************************************!*\
  !*** ./src/js/modules/accordionUpdate.js ***!
  \*******************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (accordion); //     blocks = document.querySelectorAll(itemsSelector);
// blocks.forEach(block => {
//     block.classList.add('animated', 'fadeInDown');
// });
// btns.forEach(btn => {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunction = function calcFunction() {
    ...
    if (sizeBlock.value === '' || materialBlock.value === '') {
      resultBlock.textContent = 'Время денег';
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(path.question, formData).then(function (res) {
...
var loadStyle = function loadStyle(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests_js__WEBPACK_IMPORTED_MODULE_3__["getResours"])('assets/db.json').then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = (loadStyle);
...
var mask = function mask(selector) {
  ...
  if (event.type === 'blur') {
    if (_this.value.length == 2) {
      ...
      setCursirPosition(_this.value.lenght, _this);
    }
  }
  ...
  var calcScroll = function calcScroll() {
    upElem.addEventListener('click', function (event) {
      ...
      if (this.hash !== '') {
        ...
        var hashElement = document.querySelector(this.hash.substring(1)),
            hashElementTop = 0;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Cloud not fatch ".concat(url, ",status: ").concat(res.status));
